...
from .backend import AsrBackend, CancelToken, CancelledError
from .params import JobParams
from .status_store import JobState, JobStatus, JobStatusStore


class JobRunner:
    def __init__(self, backend: AsrBackend, status_store: JobStatusStore) -> None:
        ...
        try:
            ...
            status = JobStatus(
                ...
                outputs={
                    ...
                    "segments": result.segments_path or "",
                    "words": result.words_path or "",
