...
scriberr  | time=02:50:36 level="INFO " msg="Registering adapters with environment path" model_env=/app/whisperx-env
...
scriberr  | time=02:50:36 level="INFO " msg="Preparing Whisper environment" env_path=/app/whisperx-env
