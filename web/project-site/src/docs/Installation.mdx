...
scriberr  | time=02:50:36 level="INFO " msg="Preparing NVIDIA Sortformer environment" env_path=/app/model-env/parakeet
...
scriberr  | time=02:50:36 level="INFO " msg="Preparing PyAnnote environment" env_path=/app/model-env/pyannote
...
scriberr  | time=02:50:36 level="INFO " msg="Downloading Sortformer model" path=/app/model-env/parakeet/diar_streaming_sortformer_4spk-v2.nemo
