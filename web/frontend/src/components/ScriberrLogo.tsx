...
export function ScriberrLogo({ className = "", onClick }: { className?: string; onClick?: () => void }) {
  ...
  return (
    ...
    >
      <ScriberrIcon className="h-6 sm:h-9 w-auto select-none transition-all duration-300" />
...
export function ScriberrIcon({ className = "" }: { className?: string }) {
  // Define gradient colors based on theme
  const gradientColors = { start: '#FFAB40', end: '#FF3D00' };
  ...
  return (
    ...
    >
      ...
      <g transform="translate(-107.36888,-120.07438)">
        <path
