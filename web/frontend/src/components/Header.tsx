					...
					<DropdownMenu>
						<DropdownMenuTrigger asChild>
							<Button
								variant="default"
								size="icon"
								className="bg-zinc-900 hover:bg-zinc-800 dark:bg-zinc-100 dark:hover:bg-zinc-200 text-white dark:text-zinc-900 h-10 w-10 rounded-xl shadow-sm transition-all hover:scale-105 cursor-pointer"
							>
						...
						<DropdownMenuContent
							align="end"
							className="w-56 glass-card border-zinc-200 dark:border-zinc-800 p-2"
						>
							<DropdownMenuItem
								onClick={handleQuickTranscriptionClick}
								className="flex items-center gap-3 px-3 py-2.5 cursor-pointer rounded-lg focus:bg-zinc-100 dark:focus:bg-zinc-800"
							>
					...
					<DropdownMenu>
						<DropdownMenuTrigger asChild>
							<Button
								variant="ghost"
								size="icon"
								className="h-10 w-10 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-800 cursor-pointer"
							>
								<Grip className="h-5 w-5 text-muted-foreground" />
								<span className="sr-only">Open menu</span>
							</Button>
						</DropdownMenuTrigger>
						<DropdownMenuContent align="end" className="w-48 glass-card border-zinc-200 dark:border-zinc-800 p-2">
							<DropdownMenuItem onClick={handleHomeClick} className="cursor-pointer rounded-lg focus:bg-zinc-100 dark:focus:bg-zinc-800">
								<Home className="h-4 w-4 mr-2" />
								Home
							</DropdownMenuItem>
							<DropdownMenuItem onClick={handleSettingsClick} className="cursor-pointer rounded-lg focus:bg-zinc-100 dark:focus:bg-zinc-800">
